...
# --- TELEGRAM API ---
API_ID = 'apı ıd nızı buraya yazın'
API_HASH = 'apı hashınızı buraya yazın'
HEDEF_GRUP_ID ='grup ıd  nızı buraya yazın'
...
def oto_trade_toggle():
    ...
    if not mt5_baglanti:
        messagebox.showwarning("Uyarı", "Önce MT5 bağlanmalı")
        return
